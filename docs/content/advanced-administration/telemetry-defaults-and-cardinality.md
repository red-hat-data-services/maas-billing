...
Per-user metrics are generated by Limitador (Kuadrant's rate-limiting engine) at the Istio gateway, not by maas-api. The [TelemetryPolicy](https://github.com/opendatahub-io/models-as-a-service/blob/main/deployment/base/observability/gateway-telemetry-policy.yaml) defines which labels are added to Limitador counters:
